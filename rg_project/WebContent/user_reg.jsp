...
<body>
<% ArrayList <String> dept = (ArrayList)request.getAttribute("dept");
ArrayList <String> desig = (ArrayList)request.getAttribute("desig");
%>
               ...
               <form action="UserRegistration" method="POST">
                  <div class="form-row">
                    ...
                    <input type="text" class="form-control" name="country" placeholder="country">
                     ...
                     <button type="submit" class="btn btn-primary col-2 offset-md-5">Register</button>
                  </div>
